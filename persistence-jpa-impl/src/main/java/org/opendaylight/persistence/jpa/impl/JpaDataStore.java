 ...
 * 
 */
package org.opendaylight.persistence.jpa.impl;
...
import org.opendaylight.persistence.dao.query.QueryLoggerDecorator;
...
public class JpaDataStore implements DataStore<JpaContext> {
    ...
    public <T> T execute(final Query<T, JpaContext> query) throws PersistenceException {
        ...
        final Query<T, JpaContext> queryDecorator = new QueryLoggerDecorator<T, JpaContext>(query);

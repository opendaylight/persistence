 ...
 * 
 * @param <I>
 *            type of the identifiable object's id. This type should be
 *            immutable and it is critical it implements
 *            {@link Object#equals(Object)} and {@link Object#hashCode()}
 *            correctly.
 * @param <T>
 *            type of the identifiable object (object to store in the data
 *            store)
 * @param <P>
 *            type of the entity (an object annotated with
 *            {@link javax.persistence.Entity})
 * @param <F>
 *            type of the associated filter. A DAO is responsible for
 *            translating this filter to any mechanism understood by the
 *            underlying data store or database technology. For example,
 *            predicates in JPA-based implementations, or WHERE clauses in
 *            SQL-base implementations.
 * @param <S>
 *            type of the associated sort attribute or sort key used to
 *            construct sort specifications. A DAO is responsible for
 *            translating this specification to any mechanism understood by the
 *            underlying data store or database technology. For example, ORDER
 *            BY clauses in SQL-based implementations.
...
public abstract class JpaDao<I extends Serializable, T extends Identifiable<I>, P, F, S>
	 ...
	 * 
	 * @param entityClass
	 *            class of the object annotated with
	 *            {@link javax.persistence.Entity}
	 */
	 ...
	 * @param context
	 *            data store context
	 * @return the entities that match {@code filter} sorted as stated by

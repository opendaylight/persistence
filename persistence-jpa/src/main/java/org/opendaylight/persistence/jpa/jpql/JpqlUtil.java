...
public final class JpqlUtil {
    ...
    public static <P> String getAliasInQuery(Class<P> entityClass) {
        return String.valueOf(entityClass.getSimpleName().toLowerCase()
                .charAt(0));
    }
     ...
     * @return the persistent object name in a query
     */
    public static <P> String getNameInQuery(
            SingularAttribute<? super P, ?> attribute, Class<P> entityClass) {

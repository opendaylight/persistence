 ...
 */
public abstract class BaseDaoTest<I extends Serializable, T extends Identifiable<I>, C, D extends BaseDao<I, T, C>> {
     ...
     */
    public BaseDaoTest(@Nonnull DataStore<C> dataStore) {

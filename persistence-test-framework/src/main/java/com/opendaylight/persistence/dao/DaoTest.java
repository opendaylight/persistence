 ...
 */
public abstract class DaoTest<I extends Serializable, T extends Identifiable<I>, F, S, C, D extends Dao<I, T, F, S, C>>
     ...
     */
    public DaoTest(@Nonnull DataStore<C> dataStore) {
        super(dataStore);
    }

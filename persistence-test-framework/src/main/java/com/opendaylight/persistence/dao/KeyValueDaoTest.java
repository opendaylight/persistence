 ...
 */
public abstract class KeyValueDaoTest<I extends Serializable, T extends Identifiable<I>, C, D extends KeyValueDao<I, T, C>>
     ...
     */
    public KeyValueDaoTest(@Nonnull DataStore<C> dataStore) {
        super(dataStore);
    }

 ...
 */
public abstract class OffsetPageDaoTest<I extends Serializable, T extends Identifiable<I>, F, S, C, D extends OffsetPageDao<I, T, F, S, C>>
     ...
     */
    public OffsetPageDaoTest(@Nonnull DataStore<C> dataStore) {
        super(dataStore);
    }

 ...
 */
public abstract class MarkPageDaoTest<I extends Serializable, T extends Identifiable<I>, F, S, C, D extends MarkPageDao<I, T, F, S, C>>
     ...
     */
    public MarkPageDaoTest(@Nonnull DataStore<C> dataStore) {
        super(dataStore);
    }

 ...
 * Interval.
 * <P>
 * The intervals (of real numbers) can be classified into different types. Let
 * {@code a} and {@code b} be real numbers where {@code a < b}:
 * <UL>
 ...
 * 
 * @param <C>
 *            Type of the interval domain
 * @author Fabiel Zuniga
 * @author Nachiket Abhyankar
 */
public final class Interval<C extends Comparable<C>> implements Container<C>,
        Serializable {
     ...
     * @return interval
     */
    public static <T extends Comparable<T>> Interval<T> open(T leftEndpoint,
            T rightEndpoint) {
     ...
     * @return interval
     */
    public static <T extends Comparable<T>> Interval<T> closed(T leftEndpoint,
            T rightEndpoint) {
     ...
     * @return interval
     */
    public static <T extends Comparable<T>> Interval<T> leftOpenRightClosed(
            T leftEndpoint, T rightEndpoint) {
        return new Interval<T>(leftEndpoint, rightEndpoint,
                Type.LEFT_OPEN_RIGHT_CLOSED);
    }
     ...
     * @return interval
     */
    public static <T extends Comparable<T>> Interval<T> leftClosedRightOpen(
            T leftEndpoint, T rightEndpoint) {
        return new Interval<T>(leftEndpoint, rightEndpoint,
                Type.LEFT_CLOSED_RIGHT_OPEN);
    }
     ...
     * @return interval
     */
    public static <T extends Comparable<T>> Interval<T> leftOpenRightUnbounded(
            T leftEndpoint) {
        return new Interval<T>(leftEndpoint, null,
                Type.LEFT_OPEN_RIGHT_UNBOUNDED);
    }
     ...
     * @return interval
     */
    public static <T extends Comparable<T>> Interval<T> leftClosedRightUnbounded(
            T leftEndpoint) {
        return new Interval<T>(leftEndpoint, null,
     ...
     * @return interval
     */
    public static <T extends Comparable<T>> Interval<T> leftUnboundedRightOpen(
            T rightEndpoint) {
        return new Interval<T>(null, rightEndpoint,
                Type.LEFT_UNBOUNDED_RIGHT_OPEN);
    }
     ...
     * @return interval
     */
    public static <T extends Comparable<T>> Interval<T> leftUnboundedRightClosed(
            T rightEndpoint) {
        return new Interval<T>(null, rightEndpoint,
     ...
     * {@code leftEndpoint} and {@code rightEndpoint}:
     * <ul>
     * <li>Open: if neither {@code leftEndpoint} and {@code rightEndpoint} are
     * {@code null}</li>
     * <li>Left unbounded right open: if {@code leftEndpoint} is {@code null}
     * but {@code rightEndpoint} isn't</li>
     * <li>Left open right unbounded: if {@code leftEndpoint} is not
     * {@code null} but {@code rightEndpoint} is</li>
     * <li>Unbounded: if both {@code leftEndpoint} and {@code rightEndpoint} are
     * {@code null}</li>
     * </ul>
     *
     * @param leftEndpoint
     ...
     */
    public static <T extends Comparable<T>> Interval<T> createOpen(
            T leftEndpoint, T rightEndpoint) {
     ...
     * {@code leftEndpoint} and {@code rightEndpoint}:
     * <ul>
     * <li>Closed: if neither {@code leftEndpoint} and {@code rightEndpoint} are
     * {@code null}</li>
     * <li>Left unbounded right closed: if {@code leftEndpoint} is {@code null}
     * but {@code rightEndpoint} isn't</li>
     * <li>Left closed right unbounded: if {@code leftEndpoint} is not
     * {@code null} but {@code rightEndpoint} is</li>
     * <li>Unbounded: if both {@code leftEndpoint} and {@code rightEndpoint} are
     * {@code null}</li>
     * </ul>
     ...
     * 
     */
    public static <T extends Comparable<T>> Interval<T> createClosed(
            T leftEndpoint, T rightEndpoint) {
        Interval<T> interval = null;
        if (leftEndpoint == null) {
            if (rightEndpoint == null) {
    ...
    Interval(C leftEndpoint, C rightEndpoint, Type type)
    ...
    public boolean contains(C element) {
        return element != null
                && this.type.contains(element, this.leftEndpoint,
                        this.rightEndpoint);
    }
    ...
    private boolean isLeftUnbounded() {
        return this.type == Type.UNBOUNDED
                || this.type == Type.LEFT_UNBOUNDED_RIGHT_OPEN
                || this.type == Type.LEFT_UNBOUNDED_RIGHT_CLOSED;
    }

    private boolean isRigthUnbounded() {
        return this.type == Type.UNBOUNDED
                || this.type == Type.LEFT_OPEN_RIGHT_UNBOUNDED
     ...
     */
    public <T extends Comparable<T>> Interval<T> convert(
            Converter<C, T> converter) {
        Preconditions.checkNotNull(converter, "converter");
        return new Interval<T>(converter.convert(this.leftEndpoint),
                converter.convert(this.rightEndpoint), this.type);
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hashCode(this.type, this.leftEndpoint,
                this.rightEndpoint);
    }
    ...
    public String toString() {
        return MoreObjects.toStringHelper(this)
                .add("leftEndpoint", this.leftEndpoint)
                .add("rightEndpoint", this.rightEndpoint)

 ...
 */
public final class IntervalCondition<D extends Comparable<D>> implements
        Serializable {
     ...
     */
    public static <D extends Comparable<D>> IntervalCondition<D> in(
            Interval<D> value) {
     ...
     * @return an equality condition
     */
    public static <D extends Comparable<D>> IntervalCondition<D> notIn(
            Interval<D> value) {
     ...
     */
    public <T extends Comparable<T>> IntervalCondition<T> convert(
            Converter<D, T> converter) throws NullPointerException {
        Preconditions.checkNotNull(converter, "converter");
        return new IntervalCondition<T>(this.value.convert(converter),
                this.mode);
    }

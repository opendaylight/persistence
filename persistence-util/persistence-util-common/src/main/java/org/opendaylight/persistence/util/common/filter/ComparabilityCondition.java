...
public final class ComparabilityCondition<D extends Comparable<D>> implements Serializable {
    ...
    private ComparabilityCondition(@Nonnull D value, @Nonnull Mode mode) {
     ...
     */
    public static <D extends Comparable<D>> ComparabilityCondition<D> lessThan(@Nonnull D value) {
     ...
     * @return a comparability condition
     */
    public static <D extends Comparable<D>> ComparabilityCondition<D> lessThanOrEqualTo(@Nonnull D value) {
     ...
     * @return a comparability condition
     */
    public static <D extends Comparable<D>> ComparabilityCondition<D> equalTo(@Nonnull D value) {
     ...
     * @return a comparability condition
     */
    public static <D extends Comparable<D>> ComparabilityCondition<D> greaterThanOrEqualTo(@Nonnull D value) {
     ...
     * @return a comparability condition
     */
    public static <D extends Comparable<D>> ComparabilityCondition<D> greaterThan(@Nonnull D value) {
     ...
     */
    public <T extends Comparable<T>> ComparabilityCondition<T> convert(@Nonnull Converter<D, T> converter) {

...
import org.opendaylight.persistence.util.common.type.Interval.Type;
...
public class IntervalTest {
    ...
    public void testConvertInvalid() {
        Converter<Integer, String> invalidConverter = null;
        Integer leftEndpoint = Integer.valueOf(1);
        Integer rightEndpoint = Integer.valueOf(2);
        Interval<Integer> interval = Interval.open(leftEndpoint, rightEndpoint);
        interval.convert(invalidConverter);
    }

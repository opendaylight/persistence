...
public class ObjectToStringConverterTest {
    ...
    public void testThrowableToString() {
        ...
        Assert.assertTrue(str
                .contains("at org.opendaylight.persistence.util.common.converter.ObjectToStringConverterTest.testThrowableToString(ObjectToStringConverterTest.java:"));
    }
    ...
    public void testStackTraceToString() {
        ...
        Assert.assertTrue(str
                .contains("at org.opendaylight.persistence.util.common.converter.ObjectToStringConverterTest.testStackTraceToString(ObjectToStringConverterTest.java:"));
    }

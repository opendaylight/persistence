...
public class TimePeriodTest {
    ...
    public void testInvalidConstruction() {
        final Date validStartTime = new Date(1);
        final Date invalidStartTime = null;

        final Date validEndTime = new Date(2);
    ...
    public void testEqualsAndHashCode() {
        final Date startTime = new Date(1);
        final Date endTime = new Date(2);
        final Date otherTime = new Date(3);
    ...
    public void testSerialization() {
        ...
        SerializabilityTester.testSerialization(new TimePeriod(new Date(1), new Date(2)), semanticVerifier);
    }
    ...
    public void testGetHourPeriod() {
        ...
        TimePeriod period = TimePeriod.getHourPeriod(reference.getTime(), timeZone);
        Assert.assertEquals(expectedStartTime.getTime(), period.getStartTime());
        Assert.assertEquals(expectedEndTime.getTime(), period.getEndTime());
        ...
        period = TimePeriod.getHourPeriod(reference.getTime(), twoHoursAheadTimeZone);
        Assert.assertEquals(expectedStartTime.getTime(), period.getStartTime());
        Assert.assertEquals(expectedEndTime.getTime(), period.getEndTime());
    }
    ...
    public void testGetDayPeriod() {
        ...
        TimePeriod period = TimePeriod.getDayPeriod(reference.getTime(), timeZone);
        Assert.assertEquals(expectedStartTime.getTime(), period.getStartTime());
        Assert.assertEquals(expectedEndTime.getTime(), period.getEndTime());
        ...
        period = TimePeriod.getDayPeriod(reference.getTime(), twoHoursAheadTimeZone);
        Assert.assertEquals(expectedStartTime.getTime(), period.getStartTime());
        Assert.assertEquals(expectedEndTime.getTime(), period.getEndTime());
    }
    ...
    public void testGetWeekPeriod() {
        ...
        TimePeriod period = TimePeriod.getWeekPeriod(reference.getTime(), timeZone);
        Assert.assertEquals(expectedStartTime.getTime(), period.getStartTime());
        Assert.assertEquals(expectedEndTime.getTime(), period.getEndTime());
        ...
        period = TimePeriod.getWeekPeriod(reference.getTime(), twoHoursAheadTimeZone);
        Assert.assertEquals(expectedStartTime.getTime(), period.getStartTime());
        Assert.assertEquals(expectedEndTime.getTime(), period.getEndTime());
    }
    ...
    public void testGetWeekDays() {
        ...
        Date[] week = TimePeriod.getWeekDays(reference.getTime(), timeZone);
        Assert.assertNotNull(week);
        Assert.assertEquals(7, week.length);
        Assert.assertEquals(sunday.getTime(), week[0]);
        Assert.assertEquals(monday.getTime(), week[1]);
        Assert.assertEquals(tuesday.getTime(), week[2]);
        Assert.assertEquals(wednesday.getTime(), week[3]);
        Assert.assertEquals(thrusday.getTime(), week[4]);
        Assert.assertEquals(friday.getTime(), week[5]);
        Assert.assertEquals(saturday.getTime(), week[6]);
    ...
    public void testGetMonthPeriod() {
        ...
        TimePeriod period = TimePeriod.getMonthPeriod(reference.getTime(), timeZone);
        Assert.assertEquals(expectedStartTime.getTime(), period.getStartTime());
        Assert.assertEquals(expectedEndTime.getTime(), period.getEndTime());
        ...
        period = TimePeriod.getMonthPeriod(reference.getTime(), twoHoursAheadTimeZone);
        Assert.assertEquals(expectedStartTime.getTime(), period.getStartTime());
        Assert.assertEquals(expectedEndTime.getTime(), period.getEndTime());
    }
    ...
    public void testGetYearPeriod() {
        ...
        TimePeriod period = TimePeriod.getYearPeriod(reference.getTime(), timeZone);
        Assert.assertEquals(expectedStartTime.getTime(), period.getStartTime());
        Assert.assertEquals(expectedEndTime.getTime(), period.getEndTime());
        ...
        period = TimePeriod.getYearPeriod(reference.getTime(), twoHoursAheadTimeZone);
        Assert.assertEquals(expectedStartTime.getTime(), period.getStartTime());
        Assert.assertEquals(expectedEndTime.getTime(), period.getEndTime());
    }
    ...
    public void testBreakDownHourly() {
        ...
        TimePeriod period = new TimePeriod(startTime.getTime(), endTime.getTime());
        ...
        Assert.assertEquals(firstHourStart.getTime(), daily.get(0).getStartTime());
        Assert.assertEquals(firstHourEnd.getTime(), daily.get(0).getEndTime());
        Assert.assertEquals(secondHourStart.getTime(), daily.get(1).getStartTime());
        Assert.assertEquals(secondHourEnd.getTime(), daily.get(1).getEndTime());
        Assert.assertEquals(thirdHourStart.getTime(), daily.get(2).getStartTime());
        Assert.assertEquals(thirdDayEnd.getTime(), daily.get(2).getEndTime());
    ...
    public void testBreakDownDaily() {
        ...
        Assert.assertNotNull(daily);
        Assert.assertEquals(3, daily.size());
        Assert.assertEquals(firstDayStart.getTime(), daily.get(0).getStartTime());
        Assert.assertEquals(firstDayEnd.getTime(), daily.get(0).getEndTime());
        Assert.assertEquals(secondDayStart.getTime(), daily.get(1).getStartTime());
        Assert.assertEquals(secondDayEnd.getTime(), daily.get(1).getEndTime());
        Assert.assertEquals(thirdDayStart.getTime(), daily.get(2).getStartTime());
        Assert.assertEquals(thirdDayEnd.getTime(), daily.get(2).getEndTime());
    ...
    public void testBreakDownWeekly() {
        ...
        Assert.assertEquals(firstWeekStart.getTime(), weekly.get(0).getStartTime());
        Assert.assertEquals(firstWeekEnd.getTime(), weekly.get(0).getEndTime());
        Assert.assertEquals(secondWeekStart.getTime(), weekly.get(1).getStartTime());
        Assert.assertEquals(secondWeekEnd.getTime(), weekly.get(1).getEndTime());
        Assert.assertEquals(thirdWeekStart.getTime(), weekly.get(2).getStartTime());
        Assert.assertEquals(thirdWeekEnd.getTime(), weekly.get(2).getEndTime());
    ...
    public void testBreakDownMonthly() {
        ...
        Assert.assertEquals(firstMonthStart.getTime(), monthly.get(0).getStartTime());
        Assert.assertEquals(firstMonthEnd.getTime(), monthly.get(0).getEndTime());
        Assert.assertEquals(secondMonthStart.getTime(), monthly.get(1).getStartTime());
        Assert.assertEquals(secondMonthEnd.getTime(), monthly.get(1).getEndTime());
        Assert.assertEquals(thirdMonthStart.getTime(), monthly.get(2).getStartTime());
        Assert.assertEquals(thirdMonthEnd.getTime(), monthly.get(2).getEndTime());
    ...
    public void testBreakDownYearly() {
        ...
        Assert.assertEquals(firstYearStart.getTime(), yearly.get(0).getStartTime());
        Assert.assertEquals(firstYearEnd.getTime(), yearly.get(0).getEndTime());
        Assert.assertEquals(secondYearStart.getTime(), yearly.get(1).getStartTime());
        Assert.assertEquals(secondYearEnd.getTime(), yearly.get(1).getEndTime());
        Assert.assertEquals(thirdYearStart.getTime(), yearly.get(2).getStartTime());
        Assert.assertEquals(thirdYearEnd.getTime(), yearly.get(2).getEndTime());

...
/**
 * A facade that executes methods of {@link OffsetPageDao} in the context of a {@link Query}.
 * 
 ...
 */
public interface OffsetPageObjectStore<I extends Serializable, T extends Identifiable<I>, F, S> extends
        PagedObjectStore<I, T, F, S, OffsetPageRequest, OffsetPage<T>> {

 ...
 * 
 * @param <P>
 *            type of the object directly written or read from the data store (an object that can be directly used by
 *            the underlying data store or database technology)
 * @param <T>
...
public interface UpdateStrategy<P, T> {
     ...
     *            object to update.
     */
    void validateRead(P source, T target);
     ...
     *            object to take the data from
     */
    void validateWrite(P target, T source);
}
